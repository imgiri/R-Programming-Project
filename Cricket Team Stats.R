...
Players <- c("GiriLiyangi","NishantKumar(Sr)","SubhamPrakash","Dipu","Rohit",
             ...
             "Imran","Rahul","Sumit","Vikash","Diwakar","Pintu")
#-----------------------------------------------------------------------------
...
Matches_Played<- rbind(GiriLiyangi_M,NishantKumar_Sr_M,SubhamPrakash_M,Dipu_M,Rohit_M,
                ...
                Imran_M,Rahul_M,Sumit_M,Vikash_M,Diwakar_M,Pintu_M)
...
GiriLiyangi_I_Bat<-c(1)
NishantKumar_Sr_I_Bat<-c(2)
...
GiriLiyangi_EM<-c(9)
NishantKumar_Sr_EM<-c(6,1)
SubhamPrakash_EM <- c(0)
Dipu_EM<-c(22,1)
Rohit_EM<- c(0)
SachinMeena_EM <- c(0)
DJ_EM <-c(47)
Surendra_EM <- c(37,2,2,38)
Ravindra_EM <- c(6,0)
Amitabh_EM <- c(8,18,23)
Prashant_EM <- c(46,0,15)
Avinash_EM <- c(16,54,0)
Deva_EM <- c(13)
Srikant_EM <- c(5,21)
VSandeep_EM <- c(0)
BSandeep_EM <- c(0)
...
Run_Scored<- rbind(sum(GiriLiyangi_EM),sum(NishantKumar_Sr_EM),sum(SubhamPrakash_EM),
                   ...
                   sum(Vikash_EM),sum(Diwakar_EM),sum(Pintu_EM))
...
Highest_Score<- rbind(max(GiriLiyangi_EM),max(NishantKumar_Sr_EM),max(SubhamPrakash_EM),
                      ...
                      max(Vikash_EM),max(Diwakar_EM),max(Pintu_EM))
...
rm(GiriLiyangi_EM,NishantKumar_Sr_EM,SubhamPrakash_EM,
   ...
   Imran_EM,Rahul_EM,Sumit_EM,Vikash_EM,Diwakar_EM,Pintu_EM)
...
GiriLiyangi_EM_B<-c(13)
NishantKumar_Sr_EM_B<-c(9,1)
SubhamPrakash_EM_B <- c(0)
Dipu_EM_B<-c(32,2)
Rohit_EM_B<- c(0)
SachinMeena_EM_B <- c(0)
DJ_EM_B <-c(52)
Surendra_EM_B <- c(37,4,3,54)
Ravindra_EM_B <- c(11,1)
Amitabh_EM_B <- c(19,18,36)
Prashant_EM_B <- c(53,1,28)
Avinash_EM_B <- c(16,66,2)
Deva_EM_B <- c(13)
...
Imran_EM_B <- c(1)
Rahul_EM_B <- c(0)
Sumit_EM_B <- c(38,6,3,15)
Vikash_EM_B <- c(0)
Diwakar_EM_B <- c(9)
Pintu_EM_B <- c(18,2,21,12)
...
Balls_Faced<- rbind(sum(GiriLiyangi_EM_B),sum(NishantKumar_Sr_EM_B),
                   ...
                   sum(Vikash_EM_B),sum(Diwakar_EM_B),sum(Pintu_EM_B))
...
rm(GiriLiyangi_EM_B,NishantKumar_Sr_EM_B,
   ...
   Vikash_EM_B,Diwakar_EM_B,Pintu_EM_B)
...
Not_Out <- rbind(GiriLiyangi_NO,NishantKumar_Sr_NO,SubhamPrakash_NO,
                  ...
                  Imran_NO,Rahul_NO,Sumit_NO,Vikash_NO,Diwakar_NO,Pintu_NO)
...
GiriLiyangi_4s_EM<-c(2)
NishantKumar_Sr_4s_EM <-c(0,0)
SubhamPrakash_4s_EM <- c(0)
Dipu_4s_EM<-c(4,0)
Rohit_4s_EM<- c(0)
SachinMeena_4s_EM <- c(0)
DJ_4s_EM <-c(3)
Surendra_4s_EM <- c(3,0,0,5)
Ravindra_4s_EM <- c(0,0)
Amitabh_4s_EM <- c(0,1,3)
Prashant_4s_EM <- c(6,0,2)
Avinash_4s_EM <- c(1,6,0)
Deva_4s_EM <- c(1)
Srikant_4s_EM <- c(1,4)
VSandeep_4s_EM <- c(0)
BSandeep_4s_EM <- c(0)
...
Imran_4s_EM <- c(0)
Rahul_4s_EM <- c(0)
Sumit_4s_EM <- c(4,0,0,0)
Vikash_4s_EM <- c(0)
Diwakar_4s_EM <- c(0)
Pintu_4s_EM <- c(3,0,2,0)
...
Fours <- rbind(sum(GiriLiyangi_4s_EM),sum(NishantKumar_Sr_4s_EM),
               ...
               sum(Vikash_4s_EM),
               sum(Diwakar_4s_EM),sum(Pintu_4s_EM))
...
#No. of Sixes in each match (including 0)

GiriLiyangi_6s_EM<-c(0)
NishantKumar_Sr_6s_EM <-c(0,0)
SubhamPrakash_6s_EM <- c(0)
Dipu_6s_EM<-c(0,0)
Rohit_6s_EM<- c(0)
SachinMeena_6s_EM <- c(0)
DJ_6s_EM <-c(1)
Surendra_6s_EM <- c(1,0,0,1)
Ravindra_6s_EM <- c(0,0)
Amitabh_6s_EM <- c(1,0,0)
Prashant_6s_EM <- c(2,0,0)
Avinash_6s_EM <- c(0,0,0)
Deva_6s_EM <- c(1)
Srikant_6s_EM <- c(0,0)
VSandeep_6s_EM <- c(0)
BSandeep_6s_EM <- c(0)
...
Imran_6s_EM <- c(0)
Rahul_6s_EM <- c(0)
Sumit_6s_EM <- c(1,0,0,0)
Vikash_6s_EM <- c(0)
Diwakar_6s_EM <- c(0)
Pintu_6s_EM <- c(0,0,0,0)
...
Sixes <- rbind(sum(GiriLiyangi_6s_EM),sum(NishantKumar_Sr_6s_EM),
               ...
               sum(Vikash_6s_EM),
               sum(Diwakar_6s_EM),sum(Pintu_6s_EM))
...
Fifty_Scored <- rbind(sum(GiriLiyangi_50s_EM),sum(NishantKumar_Sr_50s_EM),
                      ...
                      sum(Vikash_50s_EM),
                      sum(Diwakar_50s_EM),sum(Pintu_50s_EM))
...
Hundred_Scored <- rbind(sum(GiriLiyangi_100s_EM),sum(NishantKumar_Sr_100s_EM),
                ...
                sum(Vikash_100s_EM),
                sum(Diwakar_100s_EM),sum(Pintu_100s_EM))
...
GiriLiyangi_I_Ball<-c(0)
NishantKumar_Sr_I_Ball<-c(3)
...
GiriLiyangi_EM_BD<-c(0)
NishantKumar_Sr_EM_BD<-c(12,18,18)
SubhamPrakash_EM_BD <- c(0)
Dipu_EM_BD<-c(12)
Rohit_EM_BD<- c(0)
SachinMeena_EM_BD <- c(0)
DJ_EM_BD <-c(0)
Surendra_EM_BD <- c(24,24,6)
Ravindra_EM_BD <- c(12,24,24)
Amitabh_EM_BD <- c(24,24,12)
Prashant_EM_BD <- c(0)
Avinash_EM_BD <- c(0)
Deva_EM_BD <- c(0)
Srikant_EM_BD <- c(0)
VSandeep_EM_BD <- c(0)
BSandeep_EM_BD <- c(0)
Nishant_Jr_EM_BD <- c(31)
Imran_EM_BD <- c(12)
Rahul_EM_BD <- c(0)
Sumit_EM_BD <- c(12,24,18)
Vikash_EM_BD <- c(18)
Diwakar_EM_BD <- c(12)
Pintu_EM_BD <- c(0)
...
rm(GiriLiyangi_EM_BD,NishantKumar_Sr_EM_BD,
   ...
   Vikash_EM_BD,Diwakar_EM_BD,Pintu_EM_BD)
...
#Overs Bowled Matrix
colnames(Overs_Bowled)<- "Overs"
rownames(Overs_Bowled)<- Players
Overs_Bowled
...
GiriLiyangi_EM_RC<-c(0)
NishantKumar_Sr_EM_RC<-c(15,10,12)
SubhamPrakash_EM_RC <- c(0)
Dipu_EM_RC<-c(11)
Rohit_EM_RC<- c(0)
SachinMeena_EM_RC <- c(0)
DJ_EM_RC <-c(0)
Surendra_EM_RC <- c(22,4,11)
Ravindra_EM_RC <- c(18,10,11)
Amitabh_EM_RC <- c(12,18,21)
Prashant_EM_RC <- c(0)
Avinash_EM_RC <- c(0)
Deva_EM_RC <- c(0)
Srikant_EM_RC <- c(0)
VSandeep_EM_RC <- c(0)
BSandeep_EM_RC <- c(0)
Nishant_Jr_EM_RC <- c(20,4)
Imran_EM_RC <- c(11)
Rahul_EM_RC <- c(0)
Sumit_EM_RC <- c(17,8,14)
Vikash_EM_RC <- c(10)
Diwakar_EM_RC <- c(12)
Pintu_EM_RC <- c(0)
...
rm(GiriLiyangi_EM_RC,NishantKumar_Sr_EM_RC,
   ...
   Vikash_EM_RC,Diwakar_EM_RC,Pintu_EM_RC)
...
Maidens_Bowled <- rbind(GiriLiyangi_MB,NishantKumar_Sr_MB,SubhamPrakash_MB,
                 ...
                 Imran_MB,Rahul_MB,Sumit_MB,Vikash_MB,Diwakar_MB,Pintu_MB)
...
GiriLiyangi_EM_WT<-c(0)
NishantKumar_Sr_EM_WT<-c(1,2)
SubhamPrakash_EM_WT <- c(0)
Dipu_EM_WT<-c(2)
Rohit_EM_WT<- c(0)
SachinMeena_EM_WT <- c(0)
DJ_EM_WT <-c(0)
Surendra_EM_WT <- c(1,1)
Ravindra_EM_WT <- c(3,1)
Amitabh_EM_WT <- c(1,1,1)
Prashant_EM_WT <- c(0)
Avinash_EM_WT <- c(0)
Deva_EM_WT <- c(0)
Srikant_EM_WT <- c(0)
...
rm(GiriLiyangi_EM_WT,NishantKumar_Sr_EM_WT,
   ...
   Vikash_EM_WT,Diwakar_EM_WT,Pintu_EM_WT)
...
Five_Wicket_Haul<- rbind(GiriLiyangi_5W,NishantKumar_Sr_5W,SubhamPrakash_5W,Dipu_5W,
                       ...
                       Imran_5W,Rahul_5W,Sumit_5W,Vikash_5W,Diwakar_5W,Pintu_5W)
